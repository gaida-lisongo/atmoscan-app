        ...
        <div className="bg-white rounded-bottom smooth-shadow-sm ">
          <div className="d-flex align-items-center justify-content-between pt-4 pb-6 px-4">
            <div className="d-flex align-items-center">
              ...
              {/* text */}
              <div className="lh-1">
                <h2 className="mb-0">{entreprise?.designation}
                  <Link href="#!" className="text-decoration-none" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Beginner">
                  </Link>
                </h2>
                <p className="mb-0 d-block">{entreprise?.categorie}</p>
              </div>
            </div>
            <div>
              <Link href="#" className="btn btn-outline-primary d-none d-md-block">Mésures</Link>
            </div>
          </div>
          {/* nav */}
          <hr />
          <div div className="d-flex align-items-center justify-content-between pt-4 pb-6 px-4">
            <p className="mb-0 d-block">{entreprise?.adresse}</p>
            <p className="mb-0 d-block">{entreprise?.telephone}</p>
          </div>
        </div>
      </Col>
    </Row>
