          ...
          <div className="d-flex align-items-center justify-content-between pt-4 pb-6 px-4">
            <div className="d-flex align-items-center">
              ...
              <div className="avatar-xxl avatar-indicators avatar-online me-2 position-relative d-flex justify-content-end align-items-end mt-n10">
                <Image src={user && user?.photoPath ? user?.photoPath : "/images/avatar/avatar-1.jpg"} className="avatar-xxl rounded-circle border border-4 border-white-color-40" alt="" />
              ...
              {/* text */}
              <div className="lh-1">
                <h2 className="mb-0">{user ? user?.username : "Pas de Nom"}
                  <Link href="#!" className="text-decoration-none" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Beginner">
                  </Link>
                </h2>
                <p className="mb-0 d-block">{user ? user?.departement : "Pas de Département"} - {user ? user?.fonction : "Sans Fonction"}</p>
              </div>
            </div>
            <div>
