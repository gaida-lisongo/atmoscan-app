...
export const metadata = {
    title: 'AtmoScan - Système de Gestion Environnementale',
    description: 'AtmoScan - Plateforme de surveillance et d\'analyse des données environnementales.',
    keywords: 'AtmoScan, environnement, surveillance, données, gestion'
}
